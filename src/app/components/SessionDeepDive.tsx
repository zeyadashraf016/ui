...
const ENGINE_USAGE = [
  { name: "Knowledge", calls: 3891, color: "#7B61FF" },
  { name: "Demand", calls: 2183, color: "#00D4FF" },
  { name: "Customer", calls: 1432, color: "#FF00AA" },
  { name: "Health", calls: 1247, color: "#00FF94" },
  { name: "Margin", calls: 1089, color: "#00FFE0" },
  { name: "Stockout", calls: 834, color: "#FF3B6B" },
  { name: "PO Brain", calls: 956, color: "#00D4FF" },
  { name: "Supplier", calls: 673, color: "#FFB800" },
  { name: "Dead Stock", calls: 521, color: "#FFB800" },
];
...
const RECENT_SESSIONS = [
  { id: "ELI-2026-0610-7A3F", query: "What is our gross margin on SKU-4821 this quarter?", engine: "Margin", latency: "1,380ms", status: "ok", time: "14:22:41" },
  { id: "ELI-2026-0610-6B2E", query: "Forecast demand for Category B in Q3 2026", engine: "Demand", latency: "2,240ms", status: "ok", time: "14:21:08" },
  { id: "ELI-2026-0610-5C1D", query: "Which SKUs are at critical stockout risk?", engine: "Stockout", latency: "890ms", status: "ok", time: "14:19:55" },
  { id: "ELI-2026-0610-4A9F", query: "Show me customer retention by segment", engine: "Customer", latency: "1,720ms", status: "ok", time: "14:18:12" },
  { id: "ELI-2026-0610-3E8C", query: "Supplier lead time analysis for Q2", engine: "Supplier", latency: "6,120ms", status: "warn", time: "14:16:39" },
];
