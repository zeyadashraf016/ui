...
import { ask, Visual, AskResponse } from "../lib/api";
...
export function LiveChat() {
  ...
  async function submit(q?: string) {
    ...
    try {
      ...
      setTurns((t) => [
        ...t,
        { role: "eliara", text: res.answer, visual: res.visual, endpoint: res.endpoint_used },
      ]);
    } catch (e: any) {
      setTurns((t) => [
        ...t,
            ...
            >
              ...
              >
                ...
                {t.role === "eliara" && t.endpoint && (
                  <div style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: 9, color: "#4A5878", marginTop: 6 }}>
                    engine · {t.endpoint}
                  </div>
                )}
              </div>
